...
// Styles
import { Colors, Fonts, MainButton, SecondaryButton } from '../../../styles'
...
export const TopicButtons = styled.div`
  display: flex;
  flex-direction: column;
  padding-left: 1rem;

  ${MainButton},
  ${SecondaryButton} { margin: 0.5rem 0 0 0; }
  ...
  @media only screen and (min-width: 50rem) {
    ...
    ${MainButton},
    ${SecondaryButton} { margin: 0 0 0 1.5rem; }
  }
`
